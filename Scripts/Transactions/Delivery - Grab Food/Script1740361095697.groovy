...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.LinearLayout - grab food button'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText'), 'GF-456M', 0)
...
Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - Item Value'), '125', 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - SUBMIT ITEM VALUE DELIVERY'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - CHICKEN'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - BUFFALO'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - Item Value'), '175', 0)

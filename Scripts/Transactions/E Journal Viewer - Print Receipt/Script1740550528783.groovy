...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - REPRINT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PRINT'), 0)

...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.TextView - In-house'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.TextView - Juan S. Dela Cruz'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - SELECT'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - Rider'), 'Gericho Nol', 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - SAVE'), 0)

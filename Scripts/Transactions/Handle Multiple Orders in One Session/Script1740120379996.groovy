...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - COFFEE'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - TAKE-OUT'), 0)
...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.TextView - 4'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PAYMENT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - GCASH'), 0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - REF NO GCASH'), '2233112568970', 
    0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - CUS NO GCASH'), 'Juan Dela Cruz', 
    0)

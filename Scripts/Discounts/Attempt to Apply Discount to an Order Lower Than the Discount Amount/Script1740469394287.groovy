...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - APPETIZERS'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - NUTS'), 0)

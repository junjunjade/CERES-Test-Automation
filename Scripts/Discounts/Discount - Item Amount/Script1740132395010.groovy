...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - ITEM AMOUNT'), 0)
...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - GCASH'), 0)

Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - REF NO GCASH'), '1234567890123', 0)

Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - CUS NO GCASH'), 'Juan Dela', 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - CONFIRM'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - 2'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - 1'), 0)

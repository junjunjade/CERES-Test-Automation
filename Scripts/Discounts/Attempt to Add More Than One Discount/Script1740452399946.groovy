...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - OKAY'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - ITEM AMOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - OKAY'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - ITEM PERCENT'), 0)

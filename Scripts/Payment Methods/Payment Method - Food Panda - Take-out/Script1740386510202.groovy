...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - FOOD PANDA'), 0)

Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - REF NO GCASH'), '12345678901234', 0)

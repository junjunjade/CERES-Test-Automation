...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.TextView - Black Coffee'), 0)
...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - MASTER CARD DEBIT'), 0)

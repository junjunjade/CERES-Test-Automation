...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - MASTER CARD CREDIT'), 0)

Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - REF NO GCASH'), '12345678901234', 
    0)

Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.EditText - EXP DATE'), 0)

Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - OK - exp date'), 0)

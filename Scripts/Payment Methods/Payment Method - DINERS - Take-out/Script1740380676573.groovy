...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - DINERS'), 0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - REF NO GCASH'), '1111111111111', 
    0)

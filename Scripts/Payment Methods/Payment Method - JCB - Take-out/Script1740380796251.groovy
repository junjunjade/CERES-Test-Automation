...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - JCB'), 0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - REF NO GCASH'), '0000000000000', 
    0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - CUS NO GCASH'), 'Hehe haha', 
    0)

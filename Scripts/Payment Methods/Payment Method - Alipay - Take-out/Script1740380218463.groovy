...
Mobile.tap(findTestObject('Object Repository/Payment Methods/android.widget.Button - ALIPAY'), 0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - REF NO GCASH'), '1234567890123', 
    0)

Mobile.setText(findTestObject('Object Repository/Payment Methods/android.widget.EditText - CUS NO GCASH'), 'Juan Dela', 
    0)
